...
then
  ...
  echo "The container IP address is $ip_addr"
fi
...
then
  echo "Downloading JAR file $REMOTE_JAR_FILE"
...
then
  ...
  then
    echo "Python file not found or not a single file: $pythonfile"
...
spark-submit \
  ...
  echo "Not recognized type of application: scala|python."
fi
